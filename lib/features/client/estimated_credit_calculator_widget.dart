    ...
    return InteractiveHoverCard(
      ...
      child: Column(
        ...
        children: [
          ...
          // Section 3: Custom Card / Valu Default Income Calculation
          Row(
            textDirection: TextDirection.rtl,
            children: [
              ...
              const SizedBox(width: 6),
              const Text(
                "حسبة الدخل الافتراضي (بعد أقساط القروض والبطاقات):",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 12,
                  color: Colors.amberAccent,
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Text("بطاقات", style: TextStyle(color: Colors.white, fontSize: 12)),
                ],
              ),
          ...
          Row(
            textDirection: TextDirection.rtl,
            children: [
              // Value / Limit Input (Handwritten / Manual)
              Expanded(
                flex: 2,
                child: Directionality(
                  textDirection: TextDirection.rtl,
                  child: TextField(
                    ...
                    onChanged: (_) => setState(() {}),
                    decoration: InputDecoration(
                      labelText: _incomeType == 'card' ? "قيمة الكرت (يدوي)" : "قيمة فاليو (يدوي)",
              ...
              // Ratio Input (Handwritten / Manual)
              Expanded(
                flex: 1,
                child: Directionality(
                  textDirection: TextDirection.rtl,
                  child: TextField(
                    ...
                    onChanged: (_) => setState(() {}),
                    decoration: InputDecoration(
                      labelText: _incomeType == 'card' ? "النسبة (رقم يدوي)" : "النسبة (نسبة مئوية)",
                      labelStyle: const TextStyle(color: TfcColors.outline, fontSize: 10),
                      hintText: _incomeType == 'card' ? "مثال 1.5" : "مثال 0.35",
                      hintStyle:
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        "1. قيمة ${_incomeType == 'card' ? 'الكرت' : 'فاليو'}:",
                        style: const TextStyle(color: Colors.white70, fontSize: 11),
                      ),
                      Text(
                        "${_formatNumber(customLimit)} ج.م",
                  ...
                  Row(
                    ...
                    children: [
                      const Text(
                        "4. القسط الشهري المتاح (DBR - الالتزامات):",
                        style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 11),
                      ),
                      Text(
                        "${_formatNumber(availableMonthlyMargin)} ج.م",
                        style: TextStyle(
                          color: availableMonthlyMargin > 0 ? Colors.greenAccent : Colors.redAccent,
                          fontWeight: FontWeight.bold,
                          fontSize: 12,
                        ),
                      ),
