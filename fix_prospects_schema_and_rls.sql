-- =========================================================================
-- FIX & UPGRADE PROSPECTS TABLE AND RLS POLICIES
-- Execute this complete script in Supabase SQL Editor: https://supabase.com/dashboard
-- =========================================================================

-- 1. Enable pgcrypto / uuid extensions if not enabled
create extension if not exists "uuid-ossp";
create extension if not exists "pgcrypto";

-- 2. Create or Update Prospects Table
...
-- Ensure assigned_to_id is TEXT (to allow both UUIDs and custom IDs safely without type cast exceptions)
do $$
begin
    if exists (
        select 1 
...
-- 5. Create Permissive Policies for SELECT, INSERT, UPDATE, DELETE (Public + Authenticated)
...
-- 6. Google Sheets Config Table & Policies
